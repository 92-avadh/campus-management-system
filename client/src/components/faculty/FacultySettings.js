...
const FacultySettings = () => {
  ...
  // Get Current Faculty User from Session
  const user = JSON.parse(sessionStorage.getItem("currentUser"));
  const facultyId = user ? (user.id || user._id) : null;
    ...
    <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-3">
          ...
          >
            <FaUser className={activeSection === "info" ? "text-white" : "text-blue-500"} /> Personal Info
          </button>
          <button 
          ...
          >
            <FaShieldAlt className={activeSection === "password" ? "text-white" : "text-blue-500"} /> Security
          </button>
        </div>
            ...
            {activeSection === "info" && (
              <form onSubmit={handleUpdateInfo} className="space-y-6">
                <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-700 pb-4 mb-4">
                  <h3 className="text-lg font-bold text-gray-800 dark:text-white">Profile Details</h3>
                  {!isEditing && (
                ...
                <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        className={`w-full p-4 rounded-xl border font-bold text-sm outline-none transition-all ${
                          isEditing 
                            ? "bg-white dark:bg-gray-900 border-blue-300 focus:ring-4 focus:ring-blue-500/10 dark:text-white" 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-gray-500 mb-2 ml-1">Office Address</label>
                      <input 
                        disabled={!isEditing}
                ...
                {isEditing && (
                  <div className="flex gap-4 pt-4 border-t border-gray-100 dark:border-gray-700 animate-in fade-in">
                    ...
                    <button type="submit" disabled={loading} className="flex-1 py-3.5 rounded-xl font-bold bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-200 dark:shadow-none transition transform active:scale-95 disabled:opacity-50">
            ...
            {activeSection === "password" && (
              <form onSubmit={handleChangePassword} className="space-y-6">
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 text-amber-800 dark:text-amber-200 p-4 rounded-2xl text-xs font-bold border border-amber-100 dark:border-amber-800/30 flex items-start gap-3">
                  ...
                  <p className="mt-0.5">Changing your password will require you to log in again on all devices.</p>
                </div>
                ...
                <div className="max-w-md">
                  ...
                  <input 
                    type="password"
                    placeholder="••••••••"
                    className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 dark:text-white focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition font-bold"
                    value={passData.old}
                ...
                <div className="pt-4 border-t border-gray-100 dark:border-gray-700">
                   <button type="submit" disabled={loading} className="px-10 py-4 rounded-xl font-bold bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-black dark:hover:bg-gray-200 shadow-xl transition transform active:scale-95 disabled:opacity-50">
                    <FaLock className="inline mr-2 mb-1" /> {loading ? "Updating..." : "Update Password"}
                  </button>
                </div>
              </form>
            )}
